<template>
  ...
  <div class="table">
    <el-table :data="gridData" height="550px">
      ...
      <el-table-column prop="company" label="标题" />
      <el-table-column prop="name" label="所属分类" />
      <el-table-column prop="i" label="上传人" />
      <el-table-column prop="o" label="创建时间" />
      <el-table-column prop="p" label="审核状态" />
      ...
      <el-table-column prop="address" label="操作">
        <template #default="scope">
          ...
          <el-button size="small" type="primary" @click="drawerOpen(scope.row)">通过</el-button>
          <el-button size="small" type="primary" @click="drawerOpen(scope.row)">不通过</el-button>
