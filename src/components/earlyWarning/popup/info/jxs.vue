      ...
      >
        <el-col :span="6">
          ...
          <el-dialog v-model="infraredVisible" title="Tips" width="20%">
            ...
            <el-select
              v-model="infraredValue"
              multiple
              placeholder="请选择需要设置的时间"
...
const controlDevState = ref(true);
const options = [
  // {
  //   value: "每天",
  //   label: "00",
...
const controlDevFun = (state) => {
  // console.log(this.productNumber, 888);
  // console.log(this.infraredValue);
  if (state == 2) {
    // console.log(this.infraredValue);
    setJXStime(
      ElecDataList.value.DevData[0].productNumber,
      userName,
      infraredValue.value.toString(),
    ...
    controlDev(
      ...
      if (res.data.code == 200) {
        ...
        controlDevState.value = !controlDevState.value;
        // console.log(this.controlDevState, "woshi");
      } else {
        ElMessage({
          showClose: true,
          message: "设置失败",
