    ...
    <el-table :data="tableData" stripe style="width: 100%;margin-bottom: 50px;" height="400px">
      ...
      <el-table-column prop="address" label="操作">
        <template #default="scope">
          ...
          <el-button size="small" type="success" @click="syncDataBaseBankFun(scope.row)">生成台账到企业</el-button>
...
import { getInstBankInfo, delStandFileInfo, getRegionComp, moveToCompany, getDataBaseBank, viewCompanyList } from "@/api/index";
